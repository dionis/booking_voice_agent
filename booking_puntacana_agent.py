...
class BookingUserData:
    ...
    def summarize(self) -> str:
        data = {
            ...
            "booking_adults_number": self.booking_adults_number or "unknown",
            "booking_children_number": self.booking_children_number or "unknown",
            "booking_amount": self.booking_amount or "unknown",
