...
class Greeter(BaseAgent):
    ...
    async def on_enter(self):
        await self.session.say(
            f"Hi there! I can speak in multiple languages including Spanish, French, German, and Italian. Just ask me to switch to any of these languages. How can I help you today?")
...
async def entrypoint(ctx: JobContext):
    ...
    session = AgentSession[UserData](
        ...
        stt = deepgram.STT(model="nova-3", language = current_language) ,
        ...
        tts = cartesia.TTS(language = current_language),
